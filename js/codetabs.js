function codeTabs(tabData) {
  ...
  for (var i = 0; i < tabData.length; i++) {
    ...
    if (tabData[i].name === "Description") {
      div = $(
        "<div style='height:350px; width:735px; overflow-y:scroll; font-size: 110%;'>"
      );
    } else {
      div = $(
        "<div style='height:350px; width:735px; overflow-y:scroll; font-size: 135%;'>"
      );
    }
  ...
  var anchor = $("<a>")
    .attr("href", "#codetabs-" + tabData.length)
    .html("Theme");
  var li = $("<li>").append(anchor);
  ul.append(li);
