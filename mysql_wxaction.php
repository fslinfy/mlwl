...
switch($act) {
	case 'cpxsdshsave' :
		$retval = cpxsdshsave($link);
		break;

	case 'cpxsdmxsave' :
		$retval = cpxsdmxsave($link);
		break;
	case 'cpxsdlist' :
		$retval = cpxsdlist($link);
		break;

	case 'cpxsdmxloc' :
		$retval = cpxsdmxloc($link);
		break;


	case 'cpckdselectdata' :
		$retval = cpckdselectdata($link);
		break;
    case 'ckmclist' :
		$retval = ckmclist($link);
		break;
    case 'cpkcmenulist' :
		$retval = cpkcmenulist($link);
		break;

	case 'cphmlist' :
		$retval = cphmlist($link);
		break;
	case 'cphmedit' :
		$retval = cphmedit($link);
		break;
	case 'khuserslist' :
		$retval = khuserslist($link);
		break;
	case 'khusersedit' :
		$retval = khusersedit($link);
		break;
	default :
...
function cpxsdlist($link) {	
	...
	//	return $sqlstr;
		...
		return getjsonstoredata($xsdquery, 0);
