...
function printcpckd(p) {
  ...
  str =
    str +
    '<caption><br><b><font face="黑体" size="5">商品出库单</font></b></caption>';
  str = str + "<thead>";
  var upje = "";
  if (p.xjje > 0) {
    upje =
      lowMoneyToUp(p.ccje + p.xjje) + "(" + slrenderer(p.ccje + p.xjje) + "元)";
    str =
      str +
      '<tr><th width="100%" colspan="12"><table width="100%" border=0 ><tr><td style="border:0;" ></td><td style="text-align:right;border:0;width:50;"></td><td style="border:0;width:130;color:red; " ><strong>作业费用即结</strong></td></tr></table></th></tr>';
  }
  str =
    str +
    '<tr><th width="100%" colspan="12"><table width="100%" border=0 ><tr><td style="border:0;" ></td><td style="text-align:right;border:0;width:50;">No:</td><td style="border:0;width:130;" ><strong>' +
    p.ckdh +
    "</strong></td></tr></table></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="12"><table width="100%" border=0 ><tr>';
  str = str + '<td style="border:0;width:70;" >客户名称:</td>';
  str = str + '<td style="border:0;"><strong>' + p.khmc + "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;" >提货单号:</td><td style="border:0;"><strong>' +
    p.xsdh +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;">开单日期:</td><td style="border:0;width:90;" ><strong>' +
    p.xsrq +
    "</strong></td></tr></table></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="11"><table width="100%" border=0 ><tr>';
  str =
    str +
    '<td style="border:0;width:70;" >出库仓库:</td><td style="border:0;"><strong>' +
    p.ckmc +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;" >出库日期:</td><td  style="border:0;width:120;"><strong>' +
    p.ckrq +
    p.rq.substr(10, 6) +
    "</strong></td>   </tr></table></th></tr>";
  //表头
  ...
  str =
    str +
    '<td  style="text-align: center;width:50;"><strong>付现</strong></td>';
  str = str + "</td></tr></thead>";
  str = str + "<tbody>";
  ...
  str =
    str +
    '<tr><td style="text-align:center;">汇总 </td><td   colspan="3"><strong>出仓费用:' +
    upje +
    "</strong></td>";
  str =
    str +
  ...
  str =
    str +
    '<tr><td style="width:75;border:0; " >提货车牌:</td><td  style="border:0;" ><strong>' +
    p.cphm +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;width:60;border:0;"  >提货人:</td><td style="border:0;width:35%;" ><strong>' +
    p.thr +
    "</strong></td></tr></table>";
  str = str + "</td></tr>";
  str = str + '<tr height="50" ><td   colspan="13">';
  ...
  str =
    str +
    '<tr><th width="100%" colspan="13"><table width="100%" border=0 ><tr><td  style="border:0;width:16%;" >制单:' +
    p.czy +
    "</td>";
  ...
  str =
    str +
    '<td  style="border:0;width:36%;">提货人/电话:</td></tr></table></th></tr>';
  str = str + "<tr><th ></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="12"><table width="100%" border=0 ><tr><td  style="border:0;width:20%;" >第一联：存概</td>';
