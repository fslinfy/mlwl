...
function printCpxsd(p) {
  ...
  str =
    str +
    '<caption><br><b><font face="黑体" size="5">商品提货单</font></b></caption>';
  str = str + "<thead>";
  str =
    str +
    '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr><td style="border:0;" ></td><td style="text-align:right;border:0;width:50;">No:</td><td style="text-align:left;border:0;width:130;" ><strong>' +
    p.xsdh +
    "</strong></td></tr></table></th></tr>";
  str =
    str + '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr>';
  str =
    str +
    '<td style="text-align:left;border:0;width:70;" >提货仓库:</td><td style="text-align:left;border:0;"><strong>' +
    p.ckmc +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;">开单日期:</td><td style="text-align:left;border:0;width:80;" ><strong>' +
    p.xsrq +
    "</strong></td></tr></table></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr><td style="text-align:left;border:0;width:70;" >车牌号码:</td><td style="text-align:left;border:0;"><strong>' +
    p.cphm +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;" >提货司机:</td><td style="text-align:left;border:0;"><strong>' +
    p.sfr +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;" >有效日期:</td><td  style="text-align:left;border:0;width:80;"><strong>' +
    p.endrq +
    "</strong></td></tr></table></th></tr>";
  //表头
  str =
    str + '<tr><td style="text-align:center;" ><strong>产地名称</strong></td>';
  ...
  mx.forEach(function (rec) {
    ...
    str =
      str + '<td  style="text-align:right;">' + slrenderer(rec.xssl) + "</td>";
    str =
      str + '<td  style="text-align:right;">' + slrenderer(rec.xszl) + "</td>";
  ...
  str =
    str +
    '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr><td  style="text-align:left;border:0;width:20%;" >制单:' +
    p.czy +
    '</td><td  style="text-align:left;border:0;width:20%;">业务:' +
    p.shr +
    '</td><td  style="text-align:left;border:0;width:20%;">财务:</td><td  style="text-align:left;border:0;width:20%;">销售:</td><td  style="text-align:left;border:0;width:20%;">打印:' +
    sys_userInfo.username +
    "</td></tr></table></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr><td  style="text-align:left;border:0;width:42;" >备注:</td><td  style="text-align:left;border:1;">';
  if (p.xjbz == 1) {
    str = str + "装卸费用付现金</br>";
  }
...
function onPrintCpxsd() {
  ...
  //var p= that.getView().down("#CpxsdListGrid").getViewModel();
  PrintCpxsdxsid(xsid);
}
function PrintCpxsdxsid(xsid) {
  // console.log('PrintCpxsdxsid',xsid);
  if (xsid == 0) {
    return;
  }
  if (!LODOP) {
