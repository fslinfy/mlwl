...
function printcpgfd(p) {
  ...
  str = str + '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td style="border:0;width:70;" >客户名称:</td><td style="text-align:left;border:0;"><strong>' + p.khmc + '</strong></td>'
  if (p.xjbz) {
  ...
  str = str + '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td style="border:0;width:70;" >过货仓库:</td><td style="text-align:left;border:0;"><strong>' + p.ckmc + '</strong></td>'
  ...
  mx.forEach(function (rec) {
    str = str + '<tr><td>' + rec.cdmc + '</td><td>' + rec.xmmc + '</td><td style="text-align:center;" >' + trim(rec.jldw) + '</td><td style="text-align:right;">' + slrenderer(rec.khsl) + '</td><td  style="text-align:right;">' + slrenderer(rec.khzl) + '</td><td style="text-align:right;">' + slrenderer(rec.sl) + '</td><td  style="text-align:right;">' + slrenderer(rec.zl) + '</td><td  style="text-align:right;">' + slrenderer(rec.dj) + '</td><td  style="text-align:right;">' + slrenderer(rec.je) + '</td></tr>'
