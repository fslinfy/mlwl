...
function printcpjkd(p) {
  ...
  str =
    str +
    '<caption><br><b><font face="黑体" size="5">商品进库单</font></b></caption>';
  str = str + "<thead>";
  str =
    str +
    '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td style="border:0;" ></td><td style="text-align:right;border:0;width:50;"></td><td style="border:0;width:130;" ><strong></strong></td></tr></table></th></tr>';
  str =
    str +
    '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td style="border:0;width:70;" >客户名称:</td><td style="border:0;"><strong>' +
    p.khmc +
    '</strong></td><td style="border:0;width:30;">No:</td><td style="border:0;width:120;" ><strong>' +
    p.jkdh +
    "</strong></td></tr></table></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td style="border:0;width:70;" >进库仓库:</td><td style="border:0;"><strong>' +
    p.ckmc;
  if (p.area != "") {
    str = str + "(" + p.area + ")";
  }
  str =
    str +
    '</strong></td><td style="width:75;border:0; " >送货单号:</td><td  style="border:0;width:150;" ><strong>' +
    p.sfdh +
    '</strong></td><td style="text-align:right;border:0;width:70;">进库日期:</td><td style="border:0;width:120;" ><strong>' +
    p.jkrq +
    p.rq.substr(10, 6) +
    "</strong></td></tr></table></th></tr>";
  //表头
  str =
    str +
    '  <tr><strong><td  style="text-align:center;" ><strong>产地名称</strong></td><td  style="text-align:center;" ><strong>商品名称</strong></td><td  style="text-align: center;"><strong>批号</strong></td><td  style="text-align: center;"><strong>包装</strong></td><td  style="text-align:center;"><strong>数量(包)</strong></td><td  style="text-align:center;"><strong>重量(吨)</strong></td><td  style="text-align:center;"><strong>作业方式</strong></td><td  style="text-align:center;"><strong>仓位</strong></td></strong></tr>';
  str = str + "</thead>";
  str = str + "<tbody>";
  ...
  str =
    str +
    '  <tr><strong><td  style="text-align:center;">汇总 </td><td    colspan="3"><strong>进仓费用:' +
    lowMoneyToUp(p.jcje) +
    "(" +
    slrenderer(p.jcje) +
    "元)" +
    ...
    '</strong></td><td style="text-align:center;"><strong>' +
    slrenderer(p.jczl) +
    "</strong></td><td></td><td></td></strong></tr>";
  str = str + '<tr height="50" ><td    colspan="13">';
  str = str + '<table  style="font-size:15px;" width="100%" border="0">';
  str =
    str +
    '<tr><td style="width:75;border:0; " >送货车牌:</td><td  style="border:0;" ><strong>' +
    p.cphm +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;width:60;border:0;"  >送货人:</td><td style="border:0;width:30%;" ><strong>' +
    p.sfr +
    "</strong></td></tr></table>";
  str = str + "</td></tr>";
  str = str + '<tr height="50" ><td    colspan="13">';
  ...
  str =
    str +
    '<tr><th width="100%" colspan="9"><table width="100%" border=0 ><tr><td  style="border:0;width:20%;" >制单:' +
    p.czy +
    "</td>";
  ...
  str =
    str +
    '<td  style="border:0;width:20%;">搬运:' +
    p.byg +
    "</td></tr></table></th></tr>";
  str = str + "<tr><th ></th></tr>";
  str =
    str +
    '<tr><th width="100%" colspan="13"><table width="100%" border=0 ><tr><td  style="border:0;width:20%;" >第一联：存概</td>';
  ...
  str =
    str +
    '<td  style="border:0;width:20%;">第五联：客户</td></tr></table></th></tr>';
  str = str + "<tr><th ></th></tr>";
  str = str + "</tfoot></table>";
