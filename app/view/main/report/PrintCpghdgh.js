...
function printcpghghd(p) {
  ...
  str =
    str +
    '<td style="border:0;width:70;" >新客户:</td><td style="border:0;"><strong>' +
    p.newkhmc +
    "</strong></td>";
  str =
    str +
    '<td style="border:0;width:70;" >过货仓库:</td><td style="border:0;"><strong>' +
    p.ckmc +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:70;" >过货日期:</td><td  style="border:0;width:90;"><strong>' +
    p.ghrq +
    "</strong></td>   </tr></table></th></tr>";
  //表头
  str = str + "<tr>";
  ...
  str = str + '<td  style="text-align: center;"><strong>付现</strong></td>';
  str = str + "</td></tr></thead>";
  str = str + "<tbody>";
  mx.forEach(function (rec) {
    if (rec.mxdh < "2") {
      ...
      str =
        ...
        slrenderer(rec.cczl) +
        "</td>";
      str = str + '<td  style="text-align:center;">' + rec.zyfs + "</td>";
  ...
  str =
    str +
    '<tr><td style="text-align:center;">汇总 </td><td   colspan="3"><strong>过货费用:' +
    upje +
    "</strong></td>";
  str =
    str +
  ...
  str =
    str + '<td  style="border:0;width:36%;">过户：</td></tr></table></th></tr>';
  str = str + "<tr><th ></th></tr>";
  str =
    str +
...
function prtghghd0(prtghStore, prtghmxStore, area) {
  ...
  prtghStore.each(function (pp) {
    ...
    var ckmxid = 0;
    var ckcount = 0;
    var prtghmxStoreje = prtghmxStore;
    prtghmxStore.each(function (rec) {
      if (rec.data.area == area) {
        ...
        if (rec.data.jeid == 0) {
          ...
          zyfs = "";
          prtghmxStoreje.each(function (jerec) {
