...
function printCpghkd(p) {
  ...
  str =
    str +
    '<caption><br><b><font face="黑体" size="5">商品过户单</font></b></caption>';
  str = str + "<thead>";
  str =
    str +
  ...
  str =
    str +
    '<td style="text-align:left;border:0;width:70;" >过户仓库:</td><td style="text-align:left;border:0;"><strong>' +
    p.ckmc +
    "</strong></td>";
  str =
    str +
  ...
  str =
    str +
    '<tr><th width="100%" colspan="8"><table width="100%" border=0 ><tr><td style="text-align:left;border:0;width:70;" >接收客户</td><td style="text-align:left;border:0;"><strong>' +
    p.newkhmc +
    "</strong></td>";
  str =
    str +
    '<td style="text-align:right;border:0;width:0;" ></td><td style="text-align:left;border:0;"><strong>' +
    pjebz +
    "</strong></td>";
  str =
    str +
  ...
  str =
    ...
    p.shr +
    '</td><td  style="text-align:left;border:0;width:20%;">财务:</td><td  style="text-align:left;border:0;width:20%;">经办:</td><td  style="text-align:left;border:0;width:20%;">打印:' +
