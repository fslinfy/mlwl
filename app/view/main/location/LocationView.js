Ext.define("MyApp.view.main.location.LocationView",{extend:"Ext.grid.Panel",xtype:"LocationView",
title:"Location",
requires:[
...
id:"LocationGrid",plugins:["cellediting","gridfilters"],controller:"LocationCtrl",store:{type:"LocationStore"},
closeAction:"destroy",tbar:[{xtype:"container",flex:1,layout:"hbox",items:[
...
{text:"仓库筒称",dataIndex:"L_shortname",flex:1,align:"left",width:100,
filter:{type:"string",itemDefaults:{emptyText:"Search for\u2026"}},editor:{allowBlank:false,type:"string"}},

{text:"\u4ed3\u5e93\u5730\u5740",dataIndex:"Address",flex:1,align:"left",
filter:{type:"string",itemDefaults:{emptyText:"Search for\u2026"}},
editor:{allowBlank:true,type:"string"}},{text:"\u8054\u7cfb\u7535\u8bdd",
dataIndex:"Tel",flex:1,align:"left",editor:{allowBlank:true,type:"string"}},
{xtype:"checkcolumn",width:90,text:"\u6d3b\u8dc3",dataIndex:"Active"}
,
    {
        xtype: 'widgetcolumn',
