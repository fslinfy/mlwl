...
onBtnQueryClick:function(button,e,options){this.getView().getStore().load();return false},
...
//},
    onBtnHelpClick:function(button,e,options){console.log("help");return false},
    ...
    onBeforeReload:function(store,records,options){
        ...
        onBtnCancelClick:function(button,e,options){
            var win=this.lookupReference("popupWindow");win.close();return false},
            init:function(){
                var tool=this.getView().down("#QueryToolbarView");
        ...
        tool.down("#btnSave").setHidden(false);
          ...
          //  tool.down("#btnUndo").setHidden(false);
            ...
            this.control({"#btnQuery":{click:this.onBtnQueryClick},
           ...
           // "#btnUndo":{click:this.onBtnUndoClick},
            ...
            onFilterChange:function(v){var store=this.getView().getStore();
                var regExp=new RegExp(".*"+v.rawValue+".*");store.clearFilter();
