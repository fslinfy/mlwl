...
Ext.define("MyApp.view.main.cwgl.Cwjetj_Ctrl2", {
    ...
    requires:["MyApp.view.main.cwgl.Cwjetj_View2"],
    init:function(){
     that = this;
...
gridgroupingView = {
         ...
         mycolModel= [
            ...
            {label: '装卸',  name: 'byxjje',align: 'right',formatter:jeFormat ,sortable: false,summaryType:'sum'},
            {label: '过车',  name: 'gfxjje',align: 'right', formatter:jeFormat,sortable: false,summaryType:'sum'},
            {label: '过户',  name: 'ghxjje',align: 'right', formatter:jeFormat,sortable: false,summaryType:'sum'},
            {label: '其它',  name: 'qtxjje',align: 'right', formatter:jeFormat,sortable: false,summaryType:'sum'},
            {label: '合计',  name: 'xjje',  align: 'right', formatter:jeFormat,sortable: false,summaryType:'sum'}
            ];
