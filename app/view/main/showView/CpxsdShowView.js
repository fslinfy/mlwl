Ext.define("MyApp.view.main.showView.CpxsdShowView", {
  ...
  listeners: {
    beforedestroy: function (obj) {
      var curcpckdjeStore = that.lookupReference("cpckdmxje0").getStore();
      // console.log('curcpckdjeStore',curcpckdjeStore);
      if (curcpckdjeStore) {
        curcpckdjeStore.getProxy().clear();
        curcpckdjeStore.data.clear();
        curcpckdjeStore.sync();
      }
      var curcpckdcwStore = that.lookupReference("cpckdmxcw0").getStore();
      if (curcpckdcwStore) {
