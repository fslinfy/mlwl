                ...
                },
                {
                  ...
                  validator: function (value) {
                    ...
                    if (value < sl) {
                      panel.set(
                        "cczl",
                        Math.round((1000 * value * zl) / sl) / 1000
                      );
                    } else {
                      if (value == sl) {
                        panel.set("cczl", zl);
                  ...
                  editor: {
                    ...
                    validator: function (value) {
                      ...
                      return that.sumjs(
                        store,
                        null,
                        this.up("#cpghdmxedit").getViewModel()
                      );
                    },
                    listeners: {
                      ...
                      change: function (field, value) {
                        ...
                        selection.set(
                          "cczl",
                          Math.round(1000 * value * rate) / 1000
                        );
                  ...
                  editor: {
                    ...
                    listeners: {
                      change: function (field, value) {
                        ...
                        //var je = store.sum('je');
                        //this.up('#cpghdmxedit').getViewModel().set('ccje', je);
                      },
                    },
                  },
                },
