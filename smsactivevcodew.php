...
$link = mysqli_connect( 
'gz-cdb-p2hbsmqa.sql.tencentcdb.com:63689', /* The host to connect to 连接MySQL地址 */ 
'root', /* The user to connect as 连接MySQL用户名 */ 
'lfy670313', /* The password to use 连接MySQL密码 */ 
'wms'); /* The default database to query 连接数据库名称*/ 
